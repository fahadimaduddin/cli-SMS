...
interface Course {
    name: string;
    cost: number;
    students: string[]; // Add a new property to store student names enrolled in the course
}
...
async function addNewStudent() {
    ...
    const selectedCourseNames: { courses: string[] } = await inquirer.prompt({
        type: 'checkbox',
        name: 'courses',
    ...
    selectedCourseNames.courses.forEach((courseName: string) => {
